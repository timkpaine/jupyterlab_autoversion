...
# -*- coding: utf-8 -*-
#
# jupyterlab_autoversion documentation build configuration file, created by
...
project = 'jupyterlab_autoversion'
...
_version_py = os.path.join('..', 'jupyterlab_autoversion', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_autoversiondoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_autoversion.tex', 'jupyterlab_autoversion Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_autoversion', 'jupyterlab_autoversion Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_autoversion', 'jupyterlab_autoversion Documentation',
     author, 'jupyterlab_autoversion', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_autoversion_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_autoversion'))
