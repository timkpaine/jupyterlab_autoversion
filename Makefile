...
lint-py:  ## run python linter with ruff
	python -m ruff check jupyterlab_autoversion
	python -m ruff format --check jupyterlab_autoversion
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix jupyterlab_autoversion
	python -m ruff format jupyterlab_autoversion
...
test-py:  ## run python tests
	python -m pytest -v jupyterlab_autoversion/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v jupyterlab_autoversion/tests --cov=jupyterlab_autoversion --cov-report term-missing --cov-report xml
